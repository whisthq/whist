...
const createConfigFileFromJSON = (json) => {
  fs.writeFileSync("public/config.json", JSON.stringify(json))
}

const createConfigJSON = (env) => {
  if (env === "dev") {
    return {
...
if (require.main === module) {
  ...
  createConfigFileFromJSON(createConfigJSON(env))
