...
export const KEY_REPEAT_DELAY_RANGE_MAC =
  KEY_REPEAT_DELAY_MAX_MAC - KEY_REPEAT_DELAY_MIN_MAC
export const KEY_REPEAT_DELAY_RANGE_LINUX =
  KEY_REPEAT_DELAY_MAX_LINUX - KEY_REPEAT_DELAY_MIN_LINUX
