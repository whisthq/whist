        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="m-auto text-lg text-gray-500 max-w-screen-sm">
              You&lsquo;ll start with a one week free trial, after which
              you&lsquo;ll have to option to continue using Fractal by becoming
              a supporter.
            </p>
            <a href="/download#top">
              <FractalButton
            ...
            <div className="max-w-lg mx-auto overflow-hidden lg:max-w-none lg:flex lg:items-start">
              <div className="bg-gray-900 px-6 py-8 lg:p-12 rounded-lg">
                ...
                <p className="mt-6 text-base text-gray-400 tracking-wider">
                  You can continue using Fractal after your one week free trial
                  by becoming a supporter via a one-time, $30 supporter fee.
                  This is because our current focus is building a great product,
                  not revenue. This offer expires on Jan 1, 2022, at which point
                  we&lsquo;ll ask our supporters to help us decide a fair,
