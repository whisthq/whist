    ...
    <div>
        ...
        image={
          <div className="m-auto inline-block max-w-xs md:max-w-none">
            <div className="relative right-32 md:right-0">
              <AnimatedLineB scale={width > ScreenSize.MEDIUM ? 1.0 : 0.5} />
            </div>
            <div className="relative right-32 bottom-24 md:right-0 md:bottom-0">
              <AnimatedLineA scale={width > ScreenSize.MEDIUM ? 1.0 : 0.5} />
            </div>
      ...
      <VerticalTemplate
        ...
        title={
          <>
            <div className="text-gray dark:text-gray-300">
              Always <span className="text-blue dark:text-mint">incognito</span>
            </div>
          </>
        }
        text={
          <div className="font-body dark:text-gray-400 tracking-wider mb-4">
            Because Fractal runs in datacenters, your IP address and location
            are hidden from websites (similar to a VPN), and your browsing data
        ...
        image={
          ...
          >
            ...
            <div className="max-h-10 md:max-h-12 w-full mt-4">
              <div className="flex w-full">
                <div>
                  <img src={BrowsingData} className="w-6 mr-4" alt="data" />
                </div>
                <div className="text-lg text-gray-300 tracking-wider">
                  Browsing Data
                </div>
