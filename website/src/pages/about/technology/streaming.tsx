                        ...
                        <div className="rounded-t-lg px-6 py-8 sm:px-10 sm:pt-10 sm:pb-8">
                            <div className="relative text-lg text-gray-400 font-medium mt-8">
                                ...
                                <p className="relative">
                                    As someone who treats web browsing like
                                    depth-first search, I&lsquo;m all too
                                    familiar with the &quot;spinning wheel of
                                    death.&quot; Fractal has saved my computer
                                    from overheating or freezing, even with 30
                                    tabs open!
                                </p>
                            </div>
                        </div>
