      ...
      <div className="mx-auto py-12 max-w-7xl lg:py-24">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-3 lg:gap-8">
          <div className="space-y-5 sm:space-y-4 pr-6">
            <div className="text-3xl text-gray-300 sm:text-5xl">Meet our investors</div>
              ...
              {people.map((person) => (
                <li key={person.name}>
                  <div className="flex items-center space-x-4 lg:space-x-6">
                    <img className="w-16 h-16 rounded-full lg:w-20 lg:h-20 border-2" src={person.imageUrl} alt="" />
