    ...
    >
      ...
      >
        ...
        <p>
          ...
          personal information, information provided by you through your usage,
          credentials and payment data. Likewise, we use online identifiers to
        ...
        <p>
          <u>Summary:</u> We collect personal information that you provide to us
          such as your name, address, contact information, passwords and
          security data, payment information, and social media login data.
        </p>
        <p>
        ...
        <p>
          ...
          interaction you have with our Services, the choices you make and the
          products and features you use. We collect personal information,
          including but not limited to: publicly available personal information,
          personal information provided by you, credentials, and payment
          details.
        </p>
        <div style={{ paddingLeft: 20 }}>
          ...
          <p>
            We may collect passwords, password hints, and similar security
          ...
          <p>
            We may provide you with the option to register using social media
            account details, like your Facebook, Google, Twitter or other social
          ...
          <p>
            ...
            personal information. Failure to do so might result in your access
            to our Services being jeopardized.
          </p>
        </div>
        <p style={{ fontWeight: "bold" }}>
        ...
        <div style={{ paddingLeft: 20 }}>
          ...
          <p>
            We collect device identification (i.e. type, make, and other
            identifiers); applications; tools and protocols, such as IP
            (Internet Protocol) addresses; cookie identifiers, or others such as
            the ones used for analytics and marketing; device's geolocation; and
            other similar data.
          </p>
        </div>
        <p style={{ fontWeight: "bold", fontSize: 20 }}>
        ...
        <p>
          ...
          obligations. We use personal information collected via our Services
        ...
        <div style={{ paddingLeft: 20 }}>
          ...
          <p>
            To send you personalized marketing and promotional communications.
          ...
          <p>
            ...
            information to send you information about our product, service and
            new features, or information about changes to our terms, conditions,
            and policies.
          </p>
          <p>
            To fulfill and manage your orders. We may use your information to
          ...
          <p>
            To request feedback. We may use your information to request feedback
            and to contact you about your use of our Services.
          </p>
          <p>
            To protect our Services. We may use your information as part of our
            efforts to keep our Services safe and secure (for example, to
          ...
          <p>
            ...
            experience. We may use and store this information. In either case,
            this information will exist in aggregated and anonymized form so
        ...
        <p>
          <u>Summary:</u> We only share information with your consent, to comply
        ...
        <div style={{ paddingLeft: 20 }}>
          ...
          <p>
            <u>Consent:</u> We may process your data if you have given us
            specific consent to use your personal information for a specific
            purpose.
          </p>
          <p>
            <u>Legal Obligations:</u> We may disclose your information where we
          ...
          <p>
            <u>Vital Interests:</u> We may disclose your information where we
          ...
          <p>
            <u>Performance of a Contract:</u> Where we have entered into a
          ...
          <p>
            ...
            technologies in order to provide personalized advertisements about
            goods and services.
          </p>
        </div>
        <p style={{ fontWeight: "bold", fontSize: 20 }}>
        ...
        <p>
          <u>Summary:</u> We may use cookies and other tracking technologies to
        ...
        <p>
          ...
          set out in our <HashLink to="/cookies#top">Cookie Policy</HashLink>.
          Our Services are not officially offered in the European Union, but
          they may be accessible from that area; we take no responsibility for
          access from the European Union region with regards to cookies and
          other tracking technologies, as defined in the GDPR.
        </p>
        <p style={{ fontWeight: "bold", fontSize: 20 }}>
        ...
        <p>
          <u>Summary:</u> We keep your information for as long as necessary to
        ...
        <p>
          ...
          longer retention period is required or permitted by law (for tax,
          accounting or other legal obligations). None of our business purposes
          (described in this privacy policy) require us to keep your personal
          information after you no longer have an account with us. Once we no
          longer need to process your personal information, we will either
          delete or anonymize. In some cases it may not be possible to delete or
          anonymize your data immediately - for example if your personal
          information has been backed up in an archive. In these cases, we will
        ...
        <p>
          ...
          your own risk. We have implemented appropriate technical and
          organizational security measures designed to protect the security of
          any personal information we process. However, we cannot guarantee that
          the Internet itself is 100% secure. Consequently, you should only
        ...
        <p>
          <u>Summary:</u> We do not knowingly collect data from, or market to,
          children under 18 years of age.
        </p>
        <p>
          By using the Services, you represent that you are at least 18 years
          old or that you are the parent or guardian of such a minor and consent
        ...
        <p>
          <u>Summary:</u> We may work with, and share non-personal information
          with, third parties to serve advertisements on our behalf.
        </p>
        <p>
          We may allow third parties to serve advertisements on our behalf
          across the Internet and to provide analytics services in relation to
          the use of our Services. These entities may use cookies, web beacons
          and other technologies to collect information about your use of the
          Services and other websites, including your IP address and information
          about your web browser and operating system, pages viewed, time spent
          on pages, links clicked and conversion information. This information
          ...
          better understand your online activity. Please note that we may share
          aggregated, non-personal information, or personal information in a
          hashed, non-human readable form, with these third parties. For
          example, we may engage a third party data provider who may collect web
          log data from you or place or recognize a unique cookie on your
          browser to enable you to receive customized ads or content. These
          cookies may reflect de-identified demographic or other data linked to
          information you voluntarily provide to us (e.g., an email address) in
          a hashed, non-human readable form. For more information about
        ...
        <p>
          <u>Summary:</u> You may review, change, or terminate your account at
          any time.
        </p>
        <p>
          If you are resident in the European Economic Area and you believe we
          are unlawfully processing your personal information, you have the
        ...
        <div style={{ paddingLeft: 20 }}>
          ...
          <p>
            ...
            Most Web browsers are set to accept cookies by default. You may be
            able to configure your browser to remove and reject cookies.
            Removing or rejecting cookies may reduce the effectiveness of
            certain features of our Services. To opt-out of interest-based
