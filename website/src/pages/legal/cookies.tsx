...
const Cookies = () => {
    ...
    return (
        ...
        >
            ...
            >
                ...
                <p>
                    ...
                    used, record account information, record your user
                ...
                <p>
                    ...
                    settings on your browser (see your browser Help section for
                    how to do this) or refusing cookies on the cookies consent
                    banner, when applicable. Be aware that disabling cookies
                    will affect the functionality of many other websites that
                    you visit, and will disable certain functionality and
                    features of this Site. Therefore, it is recommended that you
                ...
                <p>
                    We set industry-standard cookies to provide you the best
                ...
                <div style={{ paddingLeft: 20 }}>
                    ...
                    <p>
                        We use cookies to remember your login state when you are
                        logged in. This prevents you from having to log in every
                        single time you visit a new page. These cookies are
                        typically removed or cleared when you log out to ensure
                    ...
                    <p>
                        This Site offers subscription and digital payment
                    ...
                    <p>
                        ...
                        helpful tools, or to understand our user base more
                        accurately. These surveys may use cookies to remember
                    ...
                    <p>
                        ...
                        cookies so that this information can be accessed
        ...
        <p>
          ...
          your browser (see your browser Help section for how to do this). Be
        ...
        <p>
          ...
          <a href="/privacy#top">Privacy Policy</a>. This Cookie Policy is part
          of and is incorporated into our Privacy Policy. By using the Site, you
