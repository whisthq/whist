            ...
            >
                ...
                <div>
                    ...
                    <p>
                        ...
                        ON ACCEPTANCE OF THESE TERMS OF SERVICE. BY CLICKING ON
                        THE "ACCEPT" BUTTON AND USING THE SERVICES, YOU
                        UNCONDITIONALLY AGREE TO BE BOUND BY THESE TERMS OF
                        SERVICE. IF THESE TERMS OF SERVICE ARE CONSIDERED AN
                        OFFER, ACCEPTANCE IS EXPRESSLY LIMITED TO THESE TERMS OF
                        SERVICE. IF YOU DO NOT AGREE WITH ANY PROVISION OF THESE
                        TERMS OF SERVICE, YOU MUST CLICK ON THE "CANCEL" BUTTON
                        AND MAY NOT ACCESS OR USE THE SERVICES IN ANY MANNER FOR
                        ANY PURPOSE.
                    </p>
                    <p>
                        These Terms of Service were last updated on the date
                        specified above. It is effective between Fractal and you
                    ...
                    <p>
                        ...
                        of age. If you are under age 18, you may not, under any
                        circumstances or for any reason, use the Services. We
                        may, in our sole discretion, refuse to offer the
                        Services to any person or entity and change its
                        eligibility criteria at any time. You are solely
                        responsible for ensuring that these Terms of Service are
                        in compliance with all laws, rules and regulations
                        applicable to you. The right to access the Services is
                        revoked where these Terms of Service or use of the
                        Services is prohibited or to the extent offering, sale
                        or provision of the Services conflicts with any
                        applicable law, rule or regulation. Further, the
                        Services are offered only for your use, and not for the
                    ...
                    <p>
                        To sign up for the Services, you must register for a
                        Fractal user account (a "User Account") on the Services
                        (an "Account"). You must provide accurate and complete
                        information and keep your Account information updated.
                        You shall not: (i) use the name of another person with
                        the intent to impersonate that person or (ii) use the
                        name of a person other than you without appropriate
                        authorization. You are solely responsible for the
                        activity that occurs on your Account, and for keeping
                        your Account password secure. You may never use another
                        person's user account or registration information for
                        the Services without permission. You must notify us
                        immediately of any change in your eligibility to use the
                        Services (including any changes to or revocation of any
                        licenses from state authorities), breach of security or
                        unauthorized use of your Account. You should never
                        publish, distribute or post login information for your
                        Account. You shall have the ability to delete your
                    ...
                    <p>
                        ...
                        will be on the same terms as the current subscription,
                        unless we have amended our pricing or other terms before
                        the renewal date, which you will be informed of ahead of
                        time should it happen.
                    </p>
                    <p>
                        The cost to you of the Services is the price that was
                        agreed by you when you purchased your subscription. This
                        price will remain unchanged until the end of your
                        then-current Subscription Period. For example, if your
                        subscription period is 30 days, then the cost to you
                        will stay the same within the 30 days of that period,
                        payable at the beginning of said period. We will inform
                        you reasonably in advance of any proposed increase in
                        the price of the Services you have purchased. You will
                        have the opportunity to approve or decline the renewal
                        of your subscription at the new price, before it is
                        charged to your account. However if you have not agreed
                        to the new price by the effective date of the proposed
                        price increase, we may at our discretion cancel your
                        subscription at the end of the then-current Subscription
                        Period, or transition you subscription to the plan which
                        is most similar to your then-current subscription.
                    </p>
                    <p>
                    ...
                    <p>
                        You are responsible for making on-time payments for your
                        Fractal subscription, as well as for updating relevant
                        payment information in the case of any changes. Fractal
                        reserves the right to suspend your access to any and all
                        Fractal services if you do not make a payment on time,
                        and/or charge late payment fees equal to ten (10) US
                        dollars per default per week. There may be a delay in
                        return to normal Services after default payments have
                    ...
                    <p>
                        ...
                        services from Fractal or to change your subscription
                        plan. For the most part, those changes will be
                        accessible from the User Account. In the case that you
                        purchase additional optional services, your purchase of
                        those services will become effective immediately,
                        subject to the time needed for activation. The optional
                        services or upgrades will be billed instantly on a pro
                        rata basis from the date of activation to the end of the
                        then-current Subscription Period. Going forward from
                        that point, the optional services or upgrades will be
                        added onto the main subscription and billed in cycle.
                    </p>
                    <p>
                        If you would like to change subscription plans to a
                        lower-priced plan, or you would like to remove optional
                        services, the change and/or removal will take effect on
                    ...
                    <p>
                        From time to time, Fractal may offer its Users benefits
                        for referring new additional customers to Fractal.
                        Access to any such program is subject to compliance with
                        these Terms by both the User and the referred User.
                    </p>
                    <p style={{ fontWeight: "bold", fontSize: 20 }}>
                        Fractal Software
                    </p>
                    ...
                    <p>
                        ...
                        with these Terms, Fractal grants you a worldwide,
                        limited, personal, non-exclusive, non-transferable,
                        non-sub-licensable, and revocable license to use the
                        software, only for private and non-commercial use, on
                        compatible User Devices belonging to the user, and for
                        the sole purpose of enabling the user to access the
                        Services offered by Fractal. This license is granted to
                        the user for the duration of the Subscription Period and
                        will terminate the end of that period. This User license
                        includes the right to download and install a copy of the
                        software on each User Device.
                    </p>
                    <p>
                        Fractal reserves all other rights to the software. These
                        rights include, but are not limited to, technological
                        protection and privacy measures included in or relating
                        to the software which you, the user, are not authorized:
                        to circumvent or avoid; Likewise, you are not authorized
                        to: disassemble, decrypt, illegally penetrate,
                        reverse-engineer, copy, use, or reconstruct the logic of
                        the software; separate the software components to use
                        them on different devices; publish, copy, rent,
                        transfer, sell, lend, distribute, export, or import the
                        software; make unauthorized use of the software in a way
                        that could disrupt services to third parties; or attempt
                        to do or assist anyone in doing the aforementioned. Any
                        of the above-mentioned behaviors would expose you to
                    ...
                    <p>
                        Use of Fractal’s Services requires a working Internet
                        connection, which is not included in our Services. The
                        quality of Fractal’s Services will depend on the quality
                        of the User’s Internet connection, in terms of
                        bandwidth, stability, ping, and a variety of other
                        factors dependent on the properties of the Internet
                        connection. The User is responsible for their own
                        Internet connection. Fractal cannot be held responsible
                        for interruptions or degradations in our Services due to
                        a User’s Internet connection; we will not offer any
                        refund if access to our Services has been interrupted or
                        degraded by your Internet connection.
                    </p>
                    <p>
                        You acknowledge that our Services may require the
                        transfer of large amounts of data over your Internet
                        connection and accept that Fractal is not responsible
                    ...
                    <ul>
                        <li>
                            Advocating or perpetrating illegal activities of any
                            kind, including any activities which would violate
                            local, state, national, federal, or international
                            laws, rules, and regulations;
                        </li>
                        <li>
                            Creating, uploading, linking or sharing fraudulent,
                            defamatory or misleading content, or intending to
                            incite crimes and offences, racial hate or suicide,
                            justify crimes against humanity, or containing child
                            pornography, or any other content of a violent or
                            pornographic nature where the content could be
                            accessed by minors;
                        </li>
                        <li>
                            Infringing any third party's copyright, patent,
                            trademark, trade secret or other proprietary rights
                            or rights of publicity or privacy, or using the
                            Services to share copyrighted material that you do
                            not own or have permission to share or distribute;
                        </li>
                        <li>
                            Disseminating any harassing, slanderous, defamatory,
                            sexually explicit, libelous, racist, indecent,
                            abusive, violent, threatening, intimidating,
                            harmful, vulgar, obscene, offensive or otherwise
                            objectionable material of any kind or nature, or
                            infringing the personal privacy or rights of third
                            parties;
                        </li>
                        <li>
                            Hacking into third-party computer systems, hosting
                            botnet-type aggressive services, spreading viruses,
                            worms, spyware, time bombs or other computer
                            programs with the purpose or effect of restricting,
                            harming or altering the proper functioning of
                            hardware or computer programs;
                        </li>
                        <li>
                            Posting, distributing, or otherwise making available
                            or transmitting any software or other computer file
                            that contains a virus, trojan horse, worm, malware
                            or other harmful or destructive component;
                        </li>
                        <li>
                            Mining cryptocurrencies, any related activities, or
                            using Fractal’s computing power to break encryption
                            keys;
                        </li>
                        <li>
                            Sending unwanted messages, promotions or
                            advertising, or spam, or modified, misleading or
                            false source identification information, including
                            by spoofing or phishing techniques, and in general,
                        ...
                        <li>
                            ...
                            whatsoever, the proper functioning of the Services,
                            including disabling, altering, infringing or
                            circumventing, or attempting to disable, alter, or
                            circumvent, in any form whatsoever, any device or
                            feature of the Services, in particular any security
                            or authentication feature, access restriction,
                            storage limit, or any standby or shut-down
                            mechanism, or modifying or using non-public areas of
                            the Services or common areas of the Services which
                            you are asked not to access;
                        </li>
                        <li>
                            Deleting from the Service or the Software any legal
                            notices, disclaimers, or proprietary notices such as
                            copyright or trademark notices, or using or
                            modifying any logo or other content of the Websites
                            without Fractal’s prior written consent;
                        </li>
                        <li>
                            Printing, copying or reverse engineering any code or
                            Fractal hardware, including any Software;
                        </li>
                        <li>
                            Taking any action that degrades, harms, disrupts or
                            interferes with the Services, the cloud equipment
                            that operates Fractal, or the security of the
                            Services or, more generally, taking any action that
                            could be harmful to Fractal or other users;
                        </li>
                        <li>
                            Analyzing, probing, or testing the vulnerability of
                            any system or network.
                        </li>
                    </ul>
                    <p>
                        We reserve the right to review your conduct and content
                        for compliance with these Terms, and to suspend your
                        access to the Services and/or cancel your subscription,
                        or take such other action as we may in our discretion
                        deem appropriate, in the event that we have reason to
                        believe that you have violated these Terms.
                    </p>
                    <p>
                        We also reserve the right to monitor, amend and/or
                        remove any content posted on the Websites. Fractal will
                        not assume any liability arising from the content in
                        your (the user’s) account. You are responsible for the
                    ...
                    <p>
                        ...
                        websites and services which are offered, controlled or
                    ...
                    <p>
                        ...
                        Content from the Services if you are in violation of
                    ...
                    <p>
                        ...
                        the foregoing data, and communicate such data to our
                        affiliates, in each case for the purposes set forth
                        above.
                    </p>
                    <p>
                    ...
                    <p>
                        Fractal grants the User, subject to compliance with
                        these Terms, a limited, non-exclusive, non-transferable,
                        non-sub-licensable and revocable license for
                        non-commercial, personal, private access, browsing and
                        use of the Websites.
                    </p>
                    <p>
                        Fractal grants the User a non-exclusive and revocable
                        right to create hyperlinks to the home page of the
                        Websites, provided that they do not portray Fractal or
                        its Services in a misleading, derogatory or offensive
                        way, or more generally, provided that they do not affect
                        Fractal in any way whatsoever.
                    </p>
                    <p>
                        The reproduction of any documents published on the
                        Websites is only permitted for information purposes, and
                        for personal and private use only. Any commercial use of
                    ...
                    <p>
                        All intellectual property associated with the Services
                        and the Software (jointly referred to as the "Fractal
                        IP") are proprietary to Fractal and/or its affiliates
                        and/or its or their suppliers, and are protected by
                        copyrights, trademarks, service marks, patents and/or
                        other proprietary rights and laws. Fractal IP includes,
                        without limitation, any trademarks, logos, trade names,
                        photographs, publications, texts, documents,
                        descriptions, slogans, domain names, patents, know-how,
                        software, source code, applications, user interfaces,
                        databases, drawings, designs and models, designs, works,
                        images, graphs, illustrations, digital downloads,
                        animated and audio sequences, and all other intellectual
                        works associated with the Services.
                    </p>
                    <p>
                        You acknowledge that by purchasing the Services you are
                        not acquiring any right in or title to the Fractal IP.
                        Except as specifically permitted herein, no portion of
                        the Fractal IP may be used or reproduced in any form, or
                        by any means. All intellectual property rights not
                        expressly granted in these Terms are reserved to Fractal
                        and its affiliates.
                    </p>
                    <p style={{ fontWeight: "bold", fontSize: 20 }}>
                        Termination By Us
                    ...
                    <p>
                        ...
                        reserves the right to suspend the Services, without
                    ...
                    <p>
                        ...
                        reaching out to your support team via the Fractal
                        website, or by any other means that may be indicated on
                        the Websites. If you decide to terminate your
                        subscription, the Services and the corresponding
                        payments will continue until the end of the then-current
                        Subscription Period, and will stop at the end of the
                        period; we will not offer any refund.
                    </p>
                    <p style={{ fontWeight: "bold", fontSize: 20 }}>
                        Territories
                    </p>
                    ...
                    <p>
                        If you believe that any content made available on or
                        through our Services has been used or exploited in a
                        manner that infringes an intellectual property right you
                        own or control, then please promptly send a DMCA Notice
                    ...
                    <p>
                        We reserve the right to delete or disable any content
                        alleged to be infringing, and/or terminate the
                        subscription of repeat infringers.
                    </p>
                    <p style={{ fontWeight: "bold", fontSize: 20 }}>
                    ...
                    <p>
                        TO THE FULLEST EXTENT PERMITTED BY LAW, (A) FRACTAL
                        MAKES NO WARRANTIES, EXPRESS OR IMPLIED, WITH RESPECT TO
                        THE SERVICES; (B) FRACTAL DISCLAIMS ANY REPRESENTATIONS
                        AND WARRANTIES, INCLUDING WITHOUT LIMITATION AS TO
                        MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE AND
                        NON-INFRINGEMENT; AND (C) EXCEPT FOR ANY LIABILITY FOR
                        FRAUD, FRAUDULENT MISREPRESENTATION OR GROSS NEGLIGENCE,
                        IN NO EVENT SHALL FRACTAL OR ITS AFFILIATES BE LIABLE TO
                        YOU OR ANY THIRD-PARTY FOR (1) ANY INDIRECT, SPECIAL,
                        PUNITIVE, INCIDENTAL, EXEMPLARY OR CONSEQUENTIAL
                        DAMAGES, OR (2) ANY LOSS OF USE, DATA, BUSINESS,
                        GOODWILL, OR PROFITS, OR THE LOSS OF USER CONTENT, OR
                        (3) ANY DAMAGE TO USER’S HARDWARE OR SOFTWARE, EVEN, IN
                        EACH CASE, IN CIRCUMSTANCES WHERE FRACTAL WAS WARNED OF
                        THE POSSIBILITY OF SUCH DAMAGES.
                    </p>
                    <p>
                        IN ADDITION, OTHER THAN FOR THE TYPES OF LIABILITY WE
                        CANNOT LIMIT BY LAW, FRACTAL AND ITS AFFILIATES’
                        LIABILITY FOR ALL CLAIMS RELATING TO ANY SERVICE WILL BE
                        CAPPED AT THE HIGHER OF $100 OR THE AMOUNTS PAID BY YOU
                        TO FRACTAL FOR THE SERVICE CONCERNED, DURING THE SIX
                        MONTHS PRECEDING THE EVENT GIVING RISE TO THE CLAIM.
                        FINALLY, YOU WILL DEFEND, INDEMNIFY AND HOLD FRACTAL,
                        ITS AFFILIATES, AND ITS AND THEIR DIRECTORS, OFFICERS
                        AND EMPLOYEES HARMLESS FROM ANY CLAIM, COST, LIABILITY,
                        LOSS OR SETTLEMENT INCURRED IN CONNECTION WITH A
                        THIRD-PARTY CLAIM ARISING OUT OF OR IN CONNECTION WITH A
                    ...
                    <p>
                        ...
                        case, you will be asked to accept the amended Terms that
                        will apply as of the start of your next billing period.
                        If you do not accept the amended Terms, the Services
                        will continue in accordance with these Terms, until the
                        end of your then-current Subscription Period. If by that
                        date you have not agreed to the amended Terms, we
                    ...
                    <p>
                        ...
                        and Fractal with respect to the subject matter of these
                        Terms, and supersede and replace any other prior or
                        contemporaneous agreements, or terms and conditions
                        applicable to the subject matter of these Terms. These
                        Terms create no third-party beneficiary rights.
                    </p>
                    <p>
                        Fractal’s failure to enforce a provision of these Terms
                        shall not be deemed a waiver of its right to do so in
                        the future. If a provision of these Terms is found to be
                        unenforceable, the remaining provisions of these Terms
                        will remain in full effect and an enforceable term will
                        be substituted reflecting as closely as possible the
                        intent of the parties. You may not assign any of your
                        rights under these Terms, and any such attempt will be
                        void. Fractal may assign its rights to any of its
                        affiliates, or to any successor in interest of any
                    ...
                    <p>
                        The parties shall endeavor to settle any disputes
                        regarding these Terms or the Services amicably before
                        submitting the case to the competent courts.
                    </p>
                    <p>
                        ...
                        submission, you or we may bring a formal proceeding.
                    </p>
                    <p>
                    ...
                    <p>
                        You and we agree to resolve any claims relating to these
                    ...
                    <p>
                        ...
                        Fractal via the email address provided. This step is not
                        necessary if you have already opted-out in a previous
                        version of these terms: your previous decision regarding
                        arbitration is still binding unless you update it.
                    </p>
                    <p>
                        ...
                        property infringement without first engaging in
                    ...
                    <p>
                        ...
                        arbitrations are NOT allowed. You may not bring a claim
                        as a plaintiff or a class member in a class,
                        consolidated, or representative action. You may only
                        resolve disputes with us on an individual basis. If this
                        specific paragraph is held unenforceable, then the
                        entirety of this "Mandatory Arbitration Provisions"
