...
//go:generate mockgen -destination=mock/$GOFILE -copyright_file=../../../scripts/copyright_file github.com/fractal/fractal/ecs-host-service/ecsagent/agent/stats/resolver ContainerMetadataResolver
