...
type CreateServiceInput struct {
	...
	//    or use Service Auto Scaling policies. Fargate tasks do not support the
...
type LogConfiguration struct {
	...
	// container agent project that is available on GitHub (https://github.com/fractal/ecs-agent)
...
type VersionInfo struct {
	...
	// (https://github.com/fractal/ecs-agent/commits/master) GitHub repository.
