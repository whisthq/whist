...
import (
	...
	acsclient "github.com/fractal/fractal/ecs-host-service/ecsagent/agent/acs/client"
	"github.com/fractal/fractal/ecs-host-service/ecsagent/agent/acs/model/ecsacs"
	updater "github.com/fractal/fractal/ecs-host-service/ecsagent/agent/acs/update_handler"
	...
	rolecredentials "github.com/fractal/fractal/ecs-host-service/ecsagent/agent/credentials"
...
func (acsSession *session) startACSSession(client wsclient.ClientServer) error {
	...
	err := client.Connect()
	if err != nil {
		// Fractal-specific change: make this a warning to avoid sentry spam
		seelog.Warnf("Error connecting to ACS: %v", err)
		return err
	}
