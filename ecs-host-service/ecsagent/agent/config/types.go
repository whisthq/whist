...
type Config struct {
	...
	// Supported types, right now, can be found in the dockerauth package: https://godoc.org/github.com/fractal/fractal/ecs-host-service/ecsagent/agent/dockerclient/dockerauth
