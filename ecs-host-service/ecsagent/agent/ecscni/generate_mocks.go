...
//go:generate mockgen -destination=mocks/ecscni_mocks.go -copyright_file=../../scripts/copyright_file github.com/fractal/fractal/ecs-host-service/ecsagent/agent/ecscni CNIClient
