package uinput // import "github.com/fractal/fractal/ecs-host-service/fractalcontainer/uinputdevices/uinput"
...
func (vk vKeyboard) Name() []byte {
	return vk.name
}

func (vk vKeyboard) DeviceFile() *os.File {
