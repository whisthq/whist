    ...
    return (
      ...
      >
        ...
        {this.state.live ? (
          <div className={styles.removeDrag}>
            <div className={styles.landingHeader}>
              ...
              <div className={styles.landingHeaderRight}>
                <span id="forgotButton" onClick={this.ForgotPassword}>
                  Forgot Password?
                </span>
                <button
                  type="button"
              ...
              <div className={styles.loginContainer}>
                ...
                >
                  {this.props.warning ? (
                    this.state.studios ? (
                      <div>
                        Invalid credentials. If you lost your password, you can
                        reset it on the&nbsp;
                        <div
          ...
          >
            {" "}
            We are currently pushing out a critical Linux update. Your app will
            be back online very soon. We apologize for the inconvenience!
          </div>
        )}
      </div>
    );
