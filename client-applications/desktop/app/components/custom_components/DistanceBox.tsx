        ...
        function showPosition(position) {
            if (public_ip && public_ip !== "") {
                iplocation(public_ip).then(function (res) {
                    ...
                    component.setState({
                        distance: dist,
                        distancebar: Math.min(
                            Math.max((220 * dist) / 1000, 80),
                            220
                        ),
                    });
                });
        ...
        if (this.state.distance < 250) {
            distanceBox = (
                <div>
                    ...
                    >
                        You are close enough to your cloud PC to experience
            ...
            distanceBox = (
                <div>
                    ...
                    >
                        You may experience slightly higher latency due to your
                        distance from your cloud PC.
                    </div>
                </div>
            );
        } else {
            distanceBox = (
                <div>
                    ...
                    >
                        You may experience latency because you are far away from
                        your cloud PC.
                    </div>
                </div>
            );
