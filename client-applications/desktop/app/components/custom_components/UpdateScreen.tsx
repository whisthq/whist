...
class UpdateScreen extends Component {
  constructor(props) {
    super(props)
    this.state = {updateScreen: false, percentageLeft: 300, percentageDownloaded: 0, downloadSpeed: 0, 
  ...
  render() {
    ...
    return (
      ...
      ?
      <div style = {{position: 'fixed', top: 0, left: 0, width: 900, height: 600, backgroundColor: '#0B172B', zIndex: 1000}}>
        {
          this.props.os === 'win32'
          ?
          <div>
        ...
        <div  style = {{position: 'relative'}}>
          <div style = {{paddingTop: 180, textAlign: 'center', color: 'white', width: 900}}>
            ...
            <div style = {{color: "#C9C9C9", fontSize: 10, margin: 'auto', marginTop: 5}}>
              {this.state.transferred} / {this.state.total} MB Downloaded
            </div>
          </div>
        </div>
      </div>
