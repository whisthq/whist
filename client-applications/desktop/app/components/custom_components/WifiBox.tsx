    ...
    if (this.state.downloadSpeed < 10) {
      internetBox = (
        <div>
          ...
          <p className={Style.text} style={{ marginTop: 8, paddingLeft: 20 }}>
            Your Internet bandwidth is slow. Try closing streaming apps like
            Youtube, Netflix, or Spotify.
          </p>
        </div>
      );
      ...
      internetBox = (
        <div>
          ...
          <h1 className={Style.header + " pl-3 ml-1"}>{this.state.ping} ms Ping</h1> */}
          <p className={Style.text} style={{ marginTop: 8, paddingLeft: 20 }}>
            Expect a smooth streaming experience with occassional image quality
            drops.
          </p>
        </div>
      );
