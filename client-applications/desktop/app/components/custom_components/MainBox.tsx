            ...
            return (
              <div className={styles.bigButton}>
                <div className={styles.centerContent}>
                  ...
                  <div className={styles.centerText}>Streaming</div>
                </div>
              </div>
            );
            ...
            return (
              <div className={styles.bigButton}>
                <div className={styles.centerContent}>
                  ...
                  <div className={styles.centerText}>Booting your cloud PC</div>
                  <div className={styles.centerSubtext}>
        ...
        return (
          <div className={styles.bigButton}>
            <div className={styles.centerContent}>
              ...
              <div className={styles.centerText}>Loading your account</div>
            </div>
          </div>
        );
      }
            ...
            >
              <div style={{ display: "flex" }}>
                <div style={{ width: "75%" }}>
                  ...
                  >
                    To change the size of text and icons in your cloud PC,
                    connect to your cloud PC, right click on the desktop, and
                    select "Display Settings". Next, click on Screen 2. Finally,
                    select the appropriate scaling factor (100%, 150%, etc.).
                  </div>
                </div>
              </div>
            </div>
