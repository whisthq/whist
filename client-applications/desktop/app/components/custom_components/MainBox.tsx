              ...
              {this.props.public_ip && this.props.public_ip !== '' ? (
                <Popup
                  ...
                  trigger={
                    <div
                      className={styles.bigBox}
                      onClick={() => this.openRestartPopup(true)}
                      style={{
                        background: 'white',
                        borderRadius: 5,
                        padding: 10,
                ...
                >
                  ...
                  >
                    Restarting your cloud PC could help. Note that restarting
                    will close any files or applications you have open.
                  </div>
                  {!this.state.vmRestarting ? (
                    <button
            ...
            >
              ...
              <div style={{ float: 'right', display: 'inline' }}>
                ...
                >
                  ...
                  >
                    This dashboard contains a list of all computers that you've
                    installed Fractal onto. You can start a remote connection to
                    any of these computers, as long `as they are turned on.
                  </div>
                </Popup>
              </div>
                      ...
                      {this.state.editNickname === index ? (
                        ...
                        <div>
                          ...
                          >
                            <FontAwesomeIcon
                              className={styles.pointerOnHover}
                              onClick={() => this.NicknameEdit(index)}
                              icon={faPencilAlt}
                              style={{
                                height: 14,
                                marginRight: 12,
            ...
            >
              <div style={{ display: 'flex' }}>
                <div style={{ width: '75%' }}>
                  ...
                  >
                    When activated, a titlebar will appear at the top of your
                    cloud PC, so you can adjust your cloud PC's position on your
                    screen.
                  </div>
                </div>
                <div style={{ width: '25%' }}>
            ...
            >
              <div style={{ display: 'flex' }}>
                <div style={{ width: '75%' }}>
                  ...
                  >
                    For now, this is an easy manual process. To change the size
                    of icons and text, go to your cloud PC desktop, right click,
                    and open "Display Settings." Next, select the "Advanced
                    Scaling Settings" option, where you'll be able to enter your
                    desired scale factor (a percentage between 100 and 500), hit
                    "Apply", and then select "Sign Out Now" in order to save
                    your changes. Once you do, your cloud PC will exit, and your
                    changes will take effect when you re-connect.
                  </div>
                </div>
                {/*
                <div style = {{width: '25%'}}>
            ...
            >
              <div style={{ display: 'flex' }}>
                <div style={{ width: '75%' }}>
                  ...
                  >
                    Toggle the maximum bandwidth (Mbps) that Fractal consumes.
                    We recommend adjusting this setting only if you are also
