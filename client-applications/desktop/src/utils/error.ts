...
export const fractalError = {
    ...
    [PROTOCOL_ERROR]: {
        ...
        text:
            "This could be due to inactivity or weak Internet. Please try again or contact support@fractal.co for help.",
    },
    ...
    [AUTH_ERROR]: {
        ...
        text:
            "Please sign out and sign back in. If this doesn't work, please contact support@fractal.co to report a bug.",
    },
    [NAVIGATION_ERROR]: {
    ...
    [INTERNET_ERROR]: {
        ...
        text:
            "We were unable to ping our servers, which is likely a result of weak Internet.",
    },
} as {
    [key: string]: {
        title: string
