...
export const hostServiceInfoIP = (res: hostServiceInfoResponse): string => res.json?.ip ?? ''

export const hostServiceInfoPort = (res: hostServiceInfoResponse): string =>
  res.json?.port ?? ''

export const hostServiceInfoSecret = (res: hostServiceInfoResponse): string =>
