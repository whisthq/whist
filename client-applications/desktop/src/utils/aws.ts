...
import { sendGraphql } from "@app/utils/api"
import { allowedRegions, AWSRegion } from "@app/@types/aws"
import config from "@app/utils/config"

const QUERY_REGION_TO_AMI = gql`
...
export const chooseRegion = async () => {
    /*
    Description:
    ...
    */
    ...
    let finalRegions = []
    const graphqlRegions = await sendGraphql(
        QUERY_REGION_TO_AMI,
        "GetRegionToAmi",
        {}
    )
