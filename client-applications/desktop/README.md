...
2. Make sure you have the latest version of Xcode and have opened it at least once. We recommend downloading Xcode from the App Store. If your Mac doesn't have the App Store, you can run these commands (replace `10.15` with your Mac's version):

```
# Explicitly retrieve macOS 10.15 SDK
wget https://github.com/phracker/MacOSX-SDKs/releases/download/10.15/MacOSX10.15.sdk.tar.xz

# Untar it
xz -d MacOSX10.15.sdk.tar.xz
tar -xf MacOSX10.15.sdk.tar
