...
exports.default = async function afterSign(context) {
    ...
    exec("codesign -f -v -s 'Fractal Computers, Inc.' \"${appOutDir}/${appName}.app/Contents/MacOS/FractalLauncher\"", (error, stdout, stderr) => {
        if (error) {
    ...
    exec("codesign -f -v -s 'Fractal Computers, Inc.' \"${appOutDir}/${appName}.app/Contents/MacOS/Fractal\"", (error, stdout, stderr) => {
        if (error) {
            console.log(`error: ${error.message}`);
            return;
        }
