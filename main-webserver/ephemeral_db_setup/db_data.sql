...
INSERT INTO hardware.region_to_ami (region_name, ami_id, allowed, region_being_updated) VALUES ('ca-central-1', 'ami-0e429184c0b389555', false, false);
INSERT INTO hardware.region_to_ami (region_name, ami_id, allowed, region_being_updated) VALUES ('eu-central-1', 'ami-09c909bdd6519caa9', false, false);
INSERT INTO hardware.region_to_ami (region_name, ami_id, allowed, region_being_updated) VALUES ('eu-west-1', 'ami-0874c82db6061c5fb', false, false);
INSERT INTO hardware.region_to_ami (region_name, ami_id, allowed, region_being_updated) VALUES ('us-east-1', 'ami-0d23c0fc96a5cf56c', true, false);
INSERT INTO hardware.region_to_ami (region_name, ami_id, allowed, region_being_updated) VALUES ('us-east-2', 'ami-02264cfde13cfcd38', false, false);
INSERT INTO hardware.region_to_ami (region_name, ami_id, allowed, region_being_updated) VALUES ('us-west-1', 'ami-033014bd25f3baf49', false, false);
INSERT INTO hardware.region_to_ami (region_name, ami_id, allowed, region_being_updated) VALUES ('us-west-2', 'ami-048e7c3ce37b079aa', false, false);
...
INSERT INTO hardware.supported_app_images (app_id, logo_url, task_definition, category, description, long_description, url, tos, active, preboot_number, task_version) VALUES ('Google Chrome', 'https://fractal-supported-app-images.s3.amazonaws.com/chrome-256.svg', 'fractal-dev-browsers-chrome', 'Browser', 'The modern web browser.', 'With Google apps like Gmail, Google Pay, and Google Assistant, Chrome can help you stay productive and get more out of your browser.', 'https://www.google.com/chrome/', 'https://www.google.com/chrome/terms/', true, 0.2, 130);
...
INSERT INTO hardware.supported_app_images (app_id, logo_url, task_definition, category, description, long_description, url, tos, active, preboot_number, task_version) VALUES ('Blender', 'https://fractal-supported-app-images.s3.amazonaws.com/blender-256.svg', 'fractal-dev-creative-blender', 'Creative', 'The free and open source 3D creation suite.', 'Blender supports the entirety of the 3D pipeline—modeling, rigging, animation, simulation, rendering, compositing and motion tracking, video editing and 2D animation pipeline.', 'https://www.blender.org/', 'https://id.blender.org/terms-of-service', true, 1, 129);
