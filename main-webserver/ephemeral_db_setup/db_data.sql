...
INSERT INTO hardware.region_to_ami (region_name, ami_id, allowed, region_being_updated) VALUES ('ca-central-1', 'ami-071df3f5bc8a54091', false, false);
INSERT INTO hardware.region_to_ami (region_name, ami_id, allowed, region_being_updated) VALUES ('eu-central-1', 'ami-0554a2f4880827d1b', false, false);
INSERT INTO hardware.region_to_ami (region_name, ami_id, allowed, region_being_updated) VALUES ('eu-west-1', 'ami-0eac3205b2034f886', false, false);
INSERT INTO hardware.region_to_ami (region_name, ami_id, allowed, region_being_updated) VALUES ('us-east-1', 'ami-00701d77bbbeed233', true, false);
INSERT INTO hardware.region_to_ami (region_name, ami_id, allowed, region_being_updated) VALUES ('us-east-2', 'ami-075146deafeb6df17', false, false);
INSERT INTO hardware.region_to_ami (region_name, ami_id, allowed, region_being_updated) VALUES ('us-west-1', 'ami-0baacbffa6a884594', false, false);
INSERT INTO hardware.region_to_ami (region_name, ami_id, allowed, region_being_updated) VALUES ('us-west-2', 'ami-06d547c6f4e218d78', false, false);
...
INSERT INTO hardware.supported_app_images (app_id, logo_url, task_definition, category, description, long_description, url, tos, active, preboot_number, task_version) VALUES ('Google Chrome', 'https://fractal-supported-app-images.s3.amazonaws.com/chrome-256.svg', 'fractal-dev-browsers-chrome', 'Browser', 'The modern web browser.', 'With Google apps like Gmail, Google Pay, and Google Assistant, Chrome can help you stay productive and get more out of your browser.', 'https://www.google.com/chrome/', 'https://www.google.com/chrome/terms/', true, 0.2, 125);
INSERT INTO hardware.supported_app_images (app_id, logo_url, task_definition, category, description, long_description, url, tos, active, preboot_number, task_version) VALUES ('Base', NULL, 'fractal-dev-base', NULL, NULL, NULL, NULL, NULL, true, 0, 124);
...
INSERT INTO hardware.supported_app_images (app_id, logo_url, task_definition, category, description, long_description, url, tos, active, preboot_number, task_version) VALUES ('Blender', 'https://fractal-supported-app-images.s3.amazonaws.com/blender-256.svg', 'fractal-dev-creative-blender', 'Creative', 'The free and open source 3D creation suite.', 'Blender supports the entirety of the 3D pipeline—modeling, rigging, animation, simulation, rendering, compositing and motion tracking, video editing and 2D animation pipeline.', 'https://www.blender.org/', 'https://id.blender.org/terms-of-service', true, 1, 124);
