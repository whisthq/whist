...
def input_token():
    resp = requests.post(
        (HEROKU_SERVER_URL + "/account/login"),
...
def lookup(username):
    return requests.post(
        (HEROKU_SERVER_URL + "/account/lookup"), json={"username": username}
    )
...
def checkVerified(username):
    return requests.post(
        (HEROKU_SERVER_URL + "/account/checkVerified"), json={"username": username}
    )
...
def makeVerified(username, token, input_token):
    return requests.post(
        (HEROKU_SERVER_URL + "/account/verifyUser"),
...
def reset(username, new_password):
    return requests.post(
        (HEROKU_SERVER_URL + "/account/reset"),
...
def fetchDisks(username):
    return requests.post(
        (HEROKU_SERVER_URL + "/user/fetchdisks"), json={"username": username}
    ).json()
