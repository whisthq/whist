...
class RegionToAmi(db.Model):
    ...
    Attributes:
        ...
        ami_being_updated:  A boolean indicating whether the AMI is currently having an initial
    ...
    ami_being_updated = db.Column(db.Boolean, nullable=False, server_default=false())
