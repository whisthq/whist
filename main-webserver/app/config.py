...
class DeploymentConfig:
    ...
    AWS_TASKS_PER_INSTANCE = int(property(getter("AWS_TASKS_PER_INSTANCE")))
...
class LocalConfig(DeploymentConfig):
    ...
    AWS_TASKS_PER_INSTANCE = int(
        property(getter("AWS_TASKS_PER_INSTANCE", default=10, fetch=False))
    )
