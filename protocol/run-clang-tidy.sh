...
FILES_EXCLUDE="include|lib|docs|sentry-native|share|nvidia-linux|lodepng\.[ch]|lodepng_test\.cpp|cm256|gf256|wirehair|windows_notification_helper|lugi_rs\.[ch]"
