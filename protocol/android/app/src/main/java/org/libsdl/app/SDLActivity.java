...
public class SDLActivity extends Activity implements View.OnSystemUiVisibilityChangeListener {
     ...
     * An array returned by a new implementation must at least contain "include.SDL2".
     * Also keep in mind that the order the libraries are loaded may matter.
     * @return names of shared libraries to be loaded (e.g. "include.SDL2", "main").
     */
    ...
    protected String[] getArguments() {
        ...
        return /*new String[5] = */new String[]{"52.170.41.191", widthPixels.toString(), heightPixels.toString()};
    }
