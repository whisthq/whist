...
void virtual_get_window_pixel_size(WhistFrontend* frontend, int id, int* width, int* height) {
    VirtualFrontendContext* context = frontend->context;
    *width = context->width;
...
WhistStatus virtual_set_title(WhistFrontend* frontend, int id, const char* title) { return WHIST_SUCCESS; }
