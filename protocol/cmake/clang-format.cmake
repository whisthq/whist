...
file(GLOB_RECURSE WHIST_DIR_C_FILES CONFIGURE_DEPENDS ${PROJECT_SOURCE_DIR}/fractal/*.c)

file(GLOB_RECURSE WHIST_DIR_H_FILES CONFIGURE_DEPENDS ${PROJECT_SOURCE_DIR}/fractal/*.h)

file(GLOB_RECURSE WHIST_DIR_M_FILES CONFIGURE_DEPENDS ${PROJECT_SOURCE_DIR}/fractal/*.m)

file(GLOB_RECURSE WHIST_DIR_CXX_FILES CONFIGURE_DEPENDS ${PROJECT_SOURCE_DIR}/fractal/*.cpp)

file(GLOB_RECURSE TEST_FILES CONFIGURE_DEPENDS ${PROJECT_SOURCE_DIR}/test/*.cpp)
