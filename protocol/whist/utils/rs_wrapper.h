...
/**
 * @brief                          Create an RS wrapper, the rs_wapper provide an interface very similar to the underlying RS lib
 *                                 but don't have the limitation of num_total_buffers<=256.
 *                                 when  num_total_buffers is too large, the orginal data are partition into groups, encoding and decoding are done group-wise
 *
