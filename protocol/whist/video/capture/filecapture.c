...
static int file_capture_screen(FileCaptureDevice *fc) {
    int err;
...
static int file_capture_device_init(FileCaptureDevice* dev, uint32_t width, uint32_t height, uint32_t dpi) {
