...
static int nvidia_reconfigure_capture_device(NvidiaCaptureDevice* dev, uint32_t width,
                                             uint32_t height, uint32_t dpi) {
    return 0;
}

static int nvidia_get_dimensions(NvidiaCaptureDevice* device, uint32_t* w, uint32_t* h,
                                 uint32_t* dpi) {
    return 0;
}
