...
static int nvidia_capture_device_init(NvidiaCaptureDevice* dev, uint32_t width, uint32_t height,
                                      uint32_t dpi) {
    return 0; /* TODO */
}

static int nvidia_reconfigure_capture_device(X11CaptureDevice* dev, uint32_t width, uint32_t height,
                                             uint32_t dpi) {
    return 0; /* TODO */
}

static int nvidia_get_dimensions(X11CaptureDevice* device, uint32_t* w, uint32_t* h,
                                 uint32_t* dpi) {
    return 0; /* TODO */
}

static int nvidia_capture_screen(NvidiaCaptureDevice* device, uint32_t* width, uint32_t* height,
                                 uint32_t* pitch) {
    /*
...
static int nvidia_capture_getdata(NvidiaCaptureDevice* device, void** buf, uint32_t* stride) {
