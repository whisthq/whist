# TODO: make the .sh equivalent of update.bat in here
# cd build64
...
# cmd.exe /c aws s3 cp server.exe s3://arn:aws:s3:us-east-1:747391415460:accesspoint/fractal-cloud-setup/FractalServer
