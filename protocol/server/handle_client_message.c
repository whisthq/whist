...
static int handle_content_drag_update_message(WhistServerState * state, WhistClientMessage *wcmsg) {
    switch (wcmsg->contentDragUpdate.update_type) {
        case CONTENT_DRAG_FILE_START: {
            LOG_INFO("CONTENT_DRAG_FILE_START");
