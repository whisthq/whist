...
#ifndef _DEVICE_SOURCE2_HH
#define _DEVICE_SOURCE2_HH
...
class DeviceParameters2 {
  //%%% TO BE WRITTEN %%%
};

class StreamSource2: public FramedSource {
public:
  static StreamSource2* createNew(UsageEnvironment& env,
...
protected:
    StreamSource2(UsageEnvironment& env, DeviceParameters2 params);
    StreamSource2(UsageEnvironment& env);
  // called only by createNew(), or by subclass constructors
  virtual ~StreamSource2();
