...
void init_server_statistics() {
    ...
    server_statistic_info[AUDIO_ENCODE_TIME] = (StatisticInfo){"AUDIO_ENCODE_TIME", true, false, false};
    server_statistic_info[CLIENT_HANDLE_USERINPUT_TIME] = (StatisticInfo){"HANDLE_USERINPUT_TIME", true, false, false};
    ...
    server_statistic_info[VIDEO_CAPTURE_CREATE_TIME] = (StatisticInfo){"VIDEO_CAPTURE_CREATE_TIME", true, false, false};
    server_statistic_info[VIDEO_CAPTURE_UPDATE_TIME] = (StatisticInfo){"VIDEO_CAPTURE_UPDATE_TIME", true, false, false};
    server_statistic_info[VIDEO_CAPTURE_SCREEN_TIME] = (StatisticInfo){"VIDEO_CAPTURE_SCREEN_TIME", true, false, false};
    server_statistic_info[VIDEO_CAPTURE_TRANSFER_TIME] =
        (StatisticInfo){"VIDEO_CAPTURE_TRANSFER_TIME", true, false, false};
    server_statistic_info[VIDEO_ENCODER_UPDATE_TIME] = (StatisticInfo){"VIDEO_ENCODER_UPDATE_TIME", true, false, false};
    server_statistic_info[VIDEO_ENCODE_TIME] = (StatisticInfo){"VIDEO_ENCODE_TIME", true, false, false};
    ...
    server_statistic_info[VIDEO_FRAME_SIZE] = (StatisticInfo){"VIDEO_FRAME_SIZE", true, false, false};
    server_statistic_info[VIDEO_FRAME_PROCESSING_TIME] =
        (StatisticInfo){"VIDEO_FRAME_PROCESSING_TIME", true, false, false};
    server_statistic_info[VIDEO_GET_CURSOR_TIME] = (StatisticInfo){"GET_CURSOR_TIME", true, false, false};
