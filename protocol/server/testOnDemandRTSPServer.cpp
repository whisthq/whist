...
static void announceStreamLive(RTSPServer* rtspServer, ServerMediaSession* sms,
  ...
  */
    {
        ...
        ServerMediaSession* sms
                = ServerMediaSession::createNew(*env, streamName, streamName,
                                                descriptionString);
        sms->addSubsession(StreamSourceMediaSubsession::createNew(*env, reuseFirstSource));
        rtspServer->addServerMediaSession(sms);
