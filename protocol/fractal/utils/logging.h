 ...
 * @file logging.h
 * @brief This fiel contains the logging macros and utils to send Winlogon status and to send the logs to the webserver.
============================
Usage
============================
 ...
 *
 * @param is_connected             The connection status to send to the server. Pass true if connected to a client and 
 *                                 false otherwise
 */
