...
#ifdef __linux__
    // When requesting _REALTIME on linux, use pthread calls directly
    // for the highest possible priority
    // (SCHED_RR being higher than any standard nice value, which is SCHED_OTHER)
