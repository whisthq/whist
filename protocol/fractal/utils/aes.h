...
/**
 * @file aes.h
 * @brief This file contains all code that interacts directly with packets encryption (using AES encryption).
============================
Usage
============================

The function encrypt_packet gets called when a new packet of data needs to be sent over the network, 
while decrypt_packet, which calls decrypt_packet_n, gets called on the receiving end to re-obtain the data and process it.
*/
 ...
 * @param private_key              AES private key used to encrypt and decrypt the packets
 * 
...
/**
 * @brief                          Calls decrypt_packet_n to decrypt an AES-encrypted packet
 * 
 ...
 * @param private_key              AES private key used to encrypt and decrypt the packets
 * 
 * @returns                        Will return -1 on failure, will return the length of the decrypted packets
 */
