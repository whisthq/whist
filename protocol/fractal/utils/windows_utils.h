...
@param currentInputDesktop      The Windows desktop that the current thread gets
set to
...
"Winlogon")
@param get_name                 If this is true, the name of the Desktop set to
gets saved in DesktopContext
@param set_thread               If this is true, the current thread gets set to
the opened Desktop

@returns                        Returns a DesktopContext with information on the
opened Desktop
*/
