  ...
  */
  ...
  switch (fcmsg->type) {
    ...
    case MESSAGE_MULTIGESTURE:
      ret = emit_multigesture_event(input_device, fcmsg->multigesture.d_theta,
                                    fcmsg->multigesture.d_dist, fcmsg->multigesture.gesture_type,
                                    fcmsg->multigesture.active_gesture);
      break;
    default:
