...
/*
        ...
        experimentally from https://www.w3schools.com/cssref/tryit.asp?filename=trycss_cursor
*/
typedef enum ChromeCursorHash {
    ARROW_CURSOR_HASH = 3933283985,
    ARROW_CURSOR_HASH_HIGH_DPI = 496816998,

    IBEAM_CURSOR_HASH = 2687203118,
    IBEAM_CURSOR_HASH_HIGH_DPI = 2370923029,

    WAIT_PROGRESS_CURSOR_HASH = 635125873,
    WAIT_PROGRESS_CURSOR_HASH_HIGH_DPI = 4067555751,
    /*
...
*/
    ...
    WAIT_CURSOR_HASH_HIGH_DPI_1 = 1209974945,
    WAIT_CURSOR_HASH_HIGH_DPI_2 = 1601805818,
    WAIT_CURSOR_HASH_HIGH_DPI_3 = 1622716605,
    WAIT_CURSOR_HASH_HIGH_DPI_4 = 1382236763,
    WAIT_CURSOR_HASH_HIGH_DPI_5 = 3655226673,
    WAIT_CURSOR_HASH_HIGH_DPI_6 = 857416147,
    WAIT_CURSOR_HASH_HIGH_DPI_7 = 1085300076,
    WAIT_CURSOR_HASH_HIGH_DPI_8 = 2983570131,
    WAIT_CURSOR_HASH_HIGH_DPI_9 = 3674477741,
    WAIT_CURSOR_HASH_HIGH_DPI_10 = 2061236017,
    WAIT_CURSOR_HASH_HIGH_DPI_11 = 3251033560,
    WAIT_CURSOR_HASH_HIGH_DPI_12 = 1472344138,
    WAIT_CURSOR_HASH_HIGH_DPI_13 = 115108627,
    WAIT_CURSOR_HASH_HIGH_DPI_14 = 171455872,
    WAIT_CURSOR_HASH_HIGH_DPI_15 = 2515503168,
    WAIT_CURSOR_HASH_HIGH_DPI_16 = 3482958344,
    WAIT_CURSOR_HASH_HIGH_DPI_17 = 1767980636,
    WAIT_CURSOR_HASH_HIGH_DPI_18 = 3696547085,
    WAIT_CURSOR_HASH_HIGH_DPI_19 = 3037722018,
    WAIT_CURSOR_HASH_HIGH_DPI_20 = 3871799193,
    WAIT_CURSOR_HASH_HIGH_DPI_21 = 2109788213,
    WAIT_CURSOR_HASH_HIGH_DPI_22 = 4286708174,
    WAIT_CURSOR_HASH_HIGH_DPI_23 = 2528494682,
    WAIT_CURSOR_HASH_HIGH_DPI_24 = 2364890396,

    NWSE_CURSOR_HASH = 2133544106,
    NWSE_CURSOR_HASH_HIGH_DPI = 782658385,

    NW_CURSOR_HASH = 1977751514,
    NW_CURSOR_HASH_HIGH_DPI = 2123818447,

    SE_CURSOR_HASH = 3001669061,
    SE_CURSOR_HASH_HIGH_DPI = 3252669343,

    NESW_CURSOR_HASH = 303720310,
    NESW_CURSOR_HASH_HIGH_DPI = 1497385425,

    SW_CURSOR_HASH = 3760849629,
    SW_CURSOR_HASH_HIGH_DPI = 1538733089,

    NE_CURSOR_HASH = 3504429407,
    NE_CURSOR_HASH_HIGH_DPI = 1539543808,

    EW_CURSOR_HASH = 1098442634,
    EW_CURSOR_HASH_HIGH_DPI = 1023179780,

    NS_CURSOR_HASH = 1522636070,
    NS_CURSOR_HASH_HIGH_DPI = 3899566618,

    NOT_ALLOWED_CURSOR_HASH = 1482285723,
    NOT_ALLOWED_CURSOR_HASH_HIGH_DPI = 60869559,

    HAND_POINT_CURSOR_HASH = 2478081084,
    HAND_POINT_CURSOR_HASH_HIGH_DPI = 2090750394,

    HAND_GRAB_CURSOR_HASH = 3452761364,
    HAND_GRAB_CURSOR_HASH_HIGH_DPI = 539538154,

    HAND_GRABBING_CURSOR_HASH = 3674173946,
    HAND_GRABBING_CURSOR_HASH_HIGH_DPI = 660243040,

    CROSSHAIR_CURSOR_HASH = 1236176635,
    CROSSHAIR_CURSOR_HASH_HIGH_DPI = 2455297158
} ChromeCursorHash;
...
FractalCursorID get_cursor_id(XFixesCursorImage* cursor_image) {
    ...
    switch (cursor_hash) {
        case ARROW_CURSOR_HASH_HIGH_DPI:
        case ARROW_CURSOR_HASH:
            id = WHIST_CURSOR_ARROW;
            break;
        case IBEAM_CURSOR_HASH_HIGH_DPI:
        case IBEAM_CURSOR_HASH:
            id = WHIST_CURSOR_IBEAM;
            break;
        case WAIT_PROGRESS_CURSOR_HASH_HIGH_DPI:
        case WAIT_PROGRESS_CURSOR_HASH:
            id = WHIST_CURSOR_WAITARROW;
            break;
        case WAIT_CURSOR_HASH_HIGH_DPI_1:
        case WAIT_CURSOR_HASH_HIGH_DPI_2:
        case WAIT_CURSOR_HASH_HIGH_DPI_3:
        case WAIT_CURSOR_HASH_HIGH_DPI_4:
        case WAIT_CURSOR_HASH_HIGH_DPI_5:
        case WAIT_CURSOR_HASH_HIGH_DPI_6:
        case WAIT_CURSOR_HASH_HIGH_DPI_7:
        case WAIT_CURSOR_HASH_HIGH_DPI_8:
        case WAIT_CURSOR_HASH_HIGH_DPI_9:
        case WAIT_CURSOR_HASH_HIGH_DPI_10:
        case WAIT_CURSOR_HASH_HIGH_DPI_11:
        case WAIT_CURSOR_HASH_HIGH_DPI_12:
        case WAIT_CURSOR_HASH_HIGH_DPI_14:
        case WAIT_CURSOR_HASH_HIGH_DPI_15:
        case WAIT_CURSOR_HASH_HIGH_DPI_16:
        case WAIT_CURSOR_HASH_HIGH_DPI_17:
        case WAIT_CURSOR_HASH_HIGH_DPI_18:
        case WAIT_CURSOR_HASH_HIGH_DPI_19:
        case WAIT_CURSOR_HASH_HIGH_DPI_20:
        case WAIT_CURSOR_HASH_HIGH_DPI_21:
        case WAIT_CURSOR_HASH_HIGH_DPI_22:
        case WAIT_CURSOR_HASH_HIGH_DPI_23:
        case WAIT_CURSOR_HASH_HIGH_DPI_24:
        ...
        case WAIT_CURSOR_HASH23:
            ...
            break;
        case NWSE_CURSOR_HASH_HIGH_DPI:
        case NWSE_CURSOR_HASH:
        case NW_CURSOR_HASH_HIGH_DPI:
        case NW_CURSOR_HASH:
        case SE_CURSOR_HASH_HIGH_DPI:
        case SE_CURSOR_HASH:
            id = WHIST_CURSOR_SIZENWSE;
            break;
        case NESW_CURSOR_HASH_HIGH_DPI:
        case NESW_CURSOR_HASH:
        case NE_CURSOR_HASH_HIGH_DPI:
        case NE_CURSOR_HASH:
        case SW_CURSOR_HASH_HIGH_DPI:
        case SW_CURSOR_HASH:
            id = WHIST_CURSOR_SIZENESW;
            break;
        case EW_CURSOR_HASH_HIGH_DPI:
        case EW_CURSOR_HASH:
            id = WHIST_CURSOR_SIZEWE;
            break;
        case NS_CURSOR_HASH_HIGH_DPI:
        case NS_CURSOR_HASH:
            id = WHIST_CURSOR_SIZENS;
            break;
        case NOT_ALLOWED_CURSOR_HASH_HIGH_DPI:
        case NOT_ALLOWED_CURSOR_HASH:
            id = WHIST_CURSOR_NO;
            break;
        case CROSSHAIR_CURSOR_HASH_HIGH_DPI:
        case CROSSHAIR_CURSOR_HASH:
            id = WHIST_CURSOR_CROSSHAIR;
            break;
        case HAND_POINT_CURSOR_HASH_HIGH_DPI:
        case HAND_POINT_CURSOR_HASH:
        case HAND_GRAB_CURSOR_HASH_HIGH_DPI:
        case HAND_GRAB_CURSOR_HASH:
        case HAND_GRABBING_CURSOR_HASH_HIGH_DPI:
