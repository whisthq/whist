...
/**
 * @brief                          Initialize an AVFrame to receive a decoded audio frame
 * 
 * @param decoder                  The audio decoder to associate the AVFrame with
 * 
 ...
 * 
 * @param decoder                  The audio decoder associated with the audio frame
 * 
...
/**
 * @brief                          Read a decoded audio packet from the decoder into a data buffer
 * 
 * @param decoder                  The audio decoder that decoded the audio packet
 ...
 * 
 * @param decoder                  The audio decoder used to decode the AAC packet
...
/**
 * @brief                          Destroy a FFmpeg AAC audio decoder, and free its memory
 * 
