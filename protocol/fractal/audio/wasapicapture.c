...
AudioDevice *create_audio_device() {
  ...
  */
  ...
  hr = audio_device->device->lpVtbl->Activate(audio_device->device, &IID_IAudioClient3, CLSCTX_ALL,
  ...
  hr = audio_device->pAudioClient->lpVtbl->GetService(audio_device->pAudioClient,
