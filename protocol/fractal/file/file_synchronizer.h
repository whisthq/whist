...
typedef enum FileTransferType {
    ...
    FILE_TRANSFER_CLIENT_DOWNLOAD  // Upload a file to the client
} FileTransferType;
 ...
 *
 * @param file_path                The file index in the synchrony array
 *
 * @param file_chunk_ptr           Pointer to pointer for filled file metadata
 */
