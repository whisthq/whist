 ...
 * @file video.h
 * @brief This file contains all code that interacts directly with receiving and processing video packets on the client.
============================
Usage
============================
 ...
 * 
 * @param packet                   Packet received from the server, which gets sorted as video
 *                                 packet with proper parameters
 * 
...
/**
 * @brief                          Calculate statistics about bitrate, I-Frame, etc. and request
 *                                 video update from the server
 */
void updateVideo();
...
/**
 * @brief                          Set the global variable 'resizing' to true if the SDL window
 *                                 is being resized, else false
 * 
