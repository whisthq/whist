...
def extract_logs_from_mandelbox(
    ...
    """
    Extract the logs related to the run of the Whist server/client mandelbox (i.e. browsers/whistium)
    ...
    Args:
        ...
        docker_id (str):    The Docker ID of the container running the Whist server/client
                            (browsers/whistium or development/client mandelbox) on the remote machine
...
def complete_experiment_and_save_results(
    ...
    - shutting down the client (development/client) and server (browsers/whistium) mandelboxes
    ...
    Args:
        ...
        server_docker_id (str): The ID of the Docker container running the server (browsers/whistium) mandelbox
    ...
    command = "(docker ps -aq | xargs -r docker stop) && (docker ps -aq | xargs -r docker rm)"
