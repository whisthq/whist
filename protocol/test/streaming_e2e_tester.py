...
if __name__ == "__main__":
    ...
    client_metrics_file = os.path.join(perf_logs_folder_name, "client", "protocol-client.log")
    server_metrics_file = os.path.join(perf_logs_folder_name, "server", "protocol-server.log")
