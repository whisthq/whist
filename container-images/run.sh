...
runcontainer (){
    docker run -it -d --cap-add SYS_ADMIN -v /sys/fs/cgroup:/sys/fs/cgroup:ro --mount type=bind,source=$(cd $3;pwd),destination=/protocol -p 5900:5900 -p 32262:32262 -p 32263:32263/udp -p 32273:32273 -p 80:80 -p 2200:22 -p 443:443 -e VNC_SERVER_PASSWORD=password -t $1-systemd-$2
}
