...
EOF
  ...
  # Note that we hardcode `distribution` to 20.04 since nvidia-docker2 is not
  # yet officially released for Ubuntu 21.04. However, the 20.04 install
  # (which just redirects to the 18.04 install) works.
