...
type HostHandler interface {
	...
	SpinUpInstances(scalingCtx context.Context, numInstances int32, maxWaitTimeReady time.Duration, image internal.Image) (createdInstances []internal.Instance, err error)
