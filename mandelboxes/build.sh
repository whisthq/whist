...
docker build --quiet -t whist/build-assets:default -f base/build-assets/Dockerfile.22 --target default base/build-assets -q > /dev/null
docker build --quiet -t whist/build-assets:protocol -f base/build-assets/Dockerfile.22 --target protocol base/build-assets -q > /dev/null
